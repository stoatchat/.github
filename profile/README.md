...
- ### [💖 Donate to Stoat](https://wiki.revolt.chat/notes/project/financial-support/): Help support the project.
  <!-- - ### [📖 Support](https://support.stoat.chat): Get help with using Stoat. -->
- ### [✨ Awesome Stoat](https://github.com/stoatchat/awesome-stoat): Find libraries, bots, clients and other cool stuff.
- ### [🔧 Developer Documentation](https://developers.revolt.chat): Documentation for developers including information on how to contribute.
  <!-- - ### [🦜 Discussions](https://github.com/orgs/stoatchat/discussions): Request features or ask questions. -->
  <!-- - ### [💻 Project Tracker](https://github.com/orgs/stoatchat/projects/3/views/1): GitHub project overview. -->
